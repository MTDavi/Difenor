                ...
                <div className='row'>
                    <div className='col-xs-12 col-md-6'>
                        <div className='about-text'>
                            ...
                            <p>
                                Unikatowym elementem naszej oferty jest zarówno oczyszczanie prywatnych posesji, jak i terenów użyteczności publicznej z uciążliwych gryzoni tj. zwalczanie kretów, nornic i innych gryzoni niszczących trawniki, rabaty z krzewami, kwiatami itp. Tak więc możemy śmiało powiedzieć, że mamy środek na kreta,nornicę oraz jej krewniaków  i wiemy, jak się ich pozbyć z miejsc, gdzie są nieproszonymi gośćmi.</p>
                            <p>
